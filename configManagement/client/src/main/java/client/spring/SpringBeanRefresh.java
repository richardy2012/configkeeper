...
//					if(pd.getName().equals(field.subSequence(field.indexOf(".")+1, field.length()))){
//						Class fieldType = pd.getPropertyType();
//						if(fieldType.isInstance(new Integer(0))){
//							setter.invoke(bean, jsonNode.get(field).getIntValue());
//						}else if(fieldType.isInstance(new Boolean(true))){
//							setter.invoke(bean, jsonNode.get(field).getBooleanValue());
//						}else if(fieldType.isInstance(new Double(0.00))){
//							setter.invoke(bean, jsonNode.get(field).asDouble());
//						}else if(fieldType.isInstance(new Long(1l))){
//							setter.invoke(bean, jsonNode.get(field).getLongValue());
//						}else if(fieldType.isInstance(new String())){
//							setter.invoke(bean, jsonNode.get(field).getTextValue());
//						}
//					}
//				}
			}
